...
uint16_t kpd_state;
char colPinMap[] = {1, 2, 3, 4};
char rowPinMap[] = {5, 6, 7, 8};
Keypad_t kpd_s {rowPinMap, sizeof(rowPinMap)/sizeof(char),
		colPinMap, sizeof(colPinMap)/sizeof(char)};
MCP17Keypad kpd(&mcp, &kpd_s, &kpd_state);
